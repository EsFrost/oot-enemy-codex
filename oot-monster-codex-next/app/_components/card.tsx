...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`bg-[#2A2A2A] text-[#E0E0E0] rounded-lg ${boss_text ? 'shadow-[5px_5px_15px_0_rgba(255,215,0,0.5)] hover:shadow-[-5px_5px_15px_0_rgba(255,215,0,0.5)]' : 'shadow-[5px_5px_15px_0_rgba(255,255,255,0.2)] hover:shadow-[-5px_5px_15px_0_rgba(255,255,255,0.2)]' } p-4 ${className} w-80 h-[500px] flex flex-col duration-500 ease-in-out transition-all min-w-[320px]`}
    >
