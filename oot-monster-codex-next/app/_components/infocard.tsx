...
const InfoCard: React.FC<Card> = ({ card, details }) => {
  ...
  return (
    <div className="flex flex-col items-center mt-4">
      ...
      <div className="w-[320px] rounded-lg mt-4 bg-[#6C6C6C]">
      ...
      <div className="flex flex-col flex-wrap w-[320px] h-auto rounded-md border p-4 mt-4">
        <div className='flex'>
          ...
          <div className="ml-2 flex">
            {Array.from({ length: (card.hp - card.hp % 4) / 4 }).map((_, index) => (
                ...
                {card.hp % 4 !== 0 ? 
                  <Image src={`/images/assets/${card.hp % 4}_4-hp.png`} alt={`${card.hp % 4}/4 heart`} width={20} height={20} className='ml-1 w-4 h-4 mt-1' /> :
                  card.hp < 4 ? 
        ...
        <div className="flex lg:ml-4">
          ...
          {Array.from({ length: (card.damage - card.damage % 4) / 4 }).map((_, index) => (
                ...
                {card.damage % 4 !== 0 ? 
                  <Image src={`/images/assets/${card.damage % 4}_4-damage.png`} alt={`${card.damage % 4}/4 heart`} width={20} height={20} className='ml-1 w-4 h-4 mt-1' /> :
                  card.damage < 4 ? 
                  <Image src={`/images/assets/0.png`} alt={`Empty heart`} width={20} height={20} className='ml-1 w-4 h-4 mt-1' /> : '' }
          </div>
        </div>
        <div className="flex lg:ml-4">
          ...
          {Array.from({ length: (card.dot - card.dot % 4) / 4 }).map((_, index) => (
                ...
                {card.dot % 4 !== 0 ? 
                  <Image src={`/images/assets/${card.dot % 4}_4-dot.png`} alt={`${card.dot % 4}/4 heart`} width={20} height={20} className='ml-1 w-4 h-4 mt-1' /> :
                  card.dot < 4 ? 
                  <Image src={`/images/assets/0.png`} alt={`Empty heart`} width={20} height={20} className='ml-1 w-4 h-4 mt-1' /> : '' }
          </div>
        </div>
          ...
          {(() => {
            switch (card.strength) {
                case 'Very weak':
                    return (
                        <div className='flex'>
                            <Image src='/images/assets/strength_very_weak.png' alt='Skull indicating very weak strength' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/skull_empty.png' alt='Empty skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/skull_empty.png' alt='Empty skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                        </div>
                ...
                case 'Weak':
                    return (
                        <div className='flex'>
                            <Image src='/images/assets/strength_weak_strong.png' alt='Skull indicating very weak strength' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/skull_empty.png' alt='Empty skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/skull_empty.png' alt='Empty skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                        </div>
                    )
                case 'Medium':
                    return (
                        <div className='flex'>
                            <Image src='/images/assets/strength_full.png' alt='Skull indicating full strength' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/strength_weak_strong.png' alt='Half skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                            <Image src='/images/assets/skull_empty.png' alt='Empty skull' width={20} height={20} className='ml-1 w-4 h-4 mt-1'></Image>
                        </div>
                    )
                case 'Strong':
