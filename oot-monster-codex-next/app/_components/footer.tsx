    ...
    <footer className='flex flex-col text-[#E0E0E0] bg-[#2A2A2A] mt-4'>
        <div className='flex flex-col lg:flex-row lg:justify-between'>
            <div className='p-4 lg:w-1/3'>
                <h2 className='text-center text-lg lg:text-left'>
                    <FontAwesomeIcon icon={faEnvelope} className='mr-2 text-md' />
                    Contact
                </h2>
            ...
            <div className='p-4 lg:w-1/3'>
                <h2 className='text-center text-lg lg:text-left'>
                    <FontAwesomeIcon icon={faGavel} className='mr-2 text-md' />
                    Disclaimer
                </h2>
            ...
            <div className='p-4 lg:w-1/3'>
                <h2 className='text-center text-lg lg:text-left'>
                    <FontAwesomeIcon icon={faCookie} className='mr-2 text-md' />
                    Cookies
                </h2>
        ...
        <div className='text-center pb-2 text-sm mt-4'>
            <p>© <span>{new Date().getFullYear()}</span> <a href='https://github.com/EsFrost'>Sigmund Frost</a></p>
        </div>
    </footer>
  )
}
